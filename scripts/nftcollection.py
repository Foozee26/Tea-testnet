...
# Constants
NETWORK_URLS = ['https://tea-sepolia.g.alchemy.com/public']  # Tea Testnet
CHAIN_ID = 10218
...
LANG = {
    'vi': {
        ...
        'no_balance': 'Số dư ví không đủ (cần ít nhất {required} TEA)',
        'estimating_gas': 'Đang ước lượng gas...'
    },
    'en': {
        'title': 'NFT MANAGEMENT - TEA TESTNET',
        'info': 'Info',
        'found': 'Found',
        'wallets': 'wallets',
        ...
        'no_balance': 'Insufficient balance (need at least {required} TEA)',
