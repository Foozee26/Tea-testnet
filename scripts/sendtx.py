...
LANG = {
    'vi': {
        'title': '✨ GỬI GIAO DỊCH - TEA TESTNET ✨',
        'info': 'ℹ Thông tin',
        'found': 'Tìm thấy',
        'wallets': 'ví',
        ...
        'enter_amount': '✦ NHẬP SỐ LƯỢNG TEA',
        'amount_prompt': 'Số lượng TEA (mặc định 0.0001, tối đa 999): ',
        'amount_unit': 'TEA',
    ...
    'en': {
        'title': '✨ SEND TRANSACTION - TEA TESTNET ✨',
        'info': 'ℹ Info',
        'found': 'Found',
        'wallets': 'wallets',
        ...
        'enter_amount': '✦ ENTER AMOUNT OF TEA',
        'amount_prompt': 'Amount of TEA (default 0.0001, max 999): ',
        'amount_unit': 'TEA',
...
async def send_transaction(w3: Web3, private_key: str, to_address: str, amount: float, wallet_index: int, tx_index: int, total_tx: int, language: str = 'en'):
    ...
    try:
        ...
        try:
            ...
            gas_limit = 21000  # Gas mặc định cho giao dịch TEA đơn giản
